...
resizedEditIcon = editIcon.resize((20,20), Image.ANTIALIAS)
imgEdit = ImageTk.PhotoImage(resizedEditIcon,master=ordersFrame)
...
img_Edit = ImageTk.PhotoImage(resized_Edit_Icon,master=ordersFrame)
...
deleteIcon = Image.open("‏‏deleteIcon.png")
resizedDeleteIcon = deleteIcon.resize((20,20), Image.ANTIALIAS)
imgDelete = ImageTk.PhotoImage(resizedDeleteIcon,master=ordersFrame)
